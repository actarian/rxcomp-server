...
this.rxcomp.server = (function (exports, rxcomp, htmlparser2) {
  'use strict';
  ...
  var RxDocument = function (_RxElement) {
    ...
    _proto8.createComment = function createComment() {};
    ...
    _proto8.createElementNS = function createElementNS() {};

    _proto8.createEvent = function createEvent() {};

    _proto8.createNodeIterator = function createNodeIterator() {};

    _proto8.createProcessingInstruction = function createProcessingInstruction() {};
